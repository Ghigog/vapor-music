    ...
    <div className="settings">
      ...
      <section className="settings__card glass">
        ...
        >
          ...
          />
          {/* Says which state the keychain is actually in.
              The placeholder alone used to read "unchanged" whether or not
              anything was stored, so a save that had silently failed looked
              identical to one that had worked. */}
